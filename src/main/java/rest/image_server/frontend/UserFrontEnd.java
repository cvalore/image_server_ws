...
public class UserFrontEnd {
    ...
    public static String getLinksRepresentation(User u) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("<h3> Useful links </h3>");
        for(Link l : u.getLinks()) {
            stringBuilder.append(getLinkRepresentation(l));
        }
        stringBuilder.append(getLinkRepresentation(u.getUploadFolderLink()));
